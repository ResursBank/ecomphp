...
/**
 * Class ResursBank
 * Works with dynamic data arrays. By default, the API-gateway will connect to Resurs Bank test environment, so to use
 * production mode this must be configured at runtime.
 *
...
class ResursBank
{
    ...
    /**
     * getPayment - Retrieves detailed information about a payment (rewritten to primarily use rest instead of SOAP, to
     * get more soap independence)
     *
     * @param string $paymentId
     * @param bool   $useSoap
     *
